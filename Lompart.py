...
CONST_DEFAULT_REQUEST_COUNT = 5                             # Constante de recuento de solicitudes predeterminada
...
def setup(nThreads, nRequests):
    ...
    threadList = [];                                            #Contiene la lista de hilos
...
def main():
    ...
    nThreads = 0; # Cantidad de hilos
    nRequests = 0; # Número total de pedidos distribuidos de forma aleatoria en los hilos
